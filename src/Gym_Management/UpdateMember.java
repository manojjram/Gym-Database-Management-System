...
public class UpdateMember extends JFrame implements ActionListener{
	...
	public UpdateMember(int dispid) {
        ...
        c3.addItemListener(new ItemListener() {
        	...
        	public void itemStateChanged(ItemEvent e) {
        		try {
        			...
        			String q = "select * from member where MemID='"+MID+"'";
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b3) {
			String MemID = c3.getSelectedItem();
			...
			try {
				ConnectionClass obj = new ConnectionClass();
				String q = "update member set MemId='"+MemID+"',fname='"+fname+"',lname='"+lname+"',gender='"+gender+"',email='"+email+"',dob='"+dob+"',cont='"+cont+"',Tname='"+Tname+"',Tcat='"+Tcat+"',hei='"+hei+"',wei='"+wei+"',remarks='"+remarks+"',address='"+address+"',amount='"+amount+"' where MemID='"+MemID+"'";
	...
	public static void main(String[] args) {
		UpdateMember uc = new UpdateMember(0);
		uc.setVisible(true);
